...
tabPanel("Interpretation",
        ...
        sidebarPanel(sliderInput("slidertrainsplit","Proportion of Training observations",min = 0, max = 1, value = 0.3, step = 0.1), sliderInput("ntreeslider","Number of Trees",min = 150, max = 1400, value = 200, step = 100),sliderInput("mtryslider","No of mtry",min = 2, max = 20, value = 4, step = 2)),
        mainPanel(p("Here goes the data exploration"), plotOutput("pdp"))
